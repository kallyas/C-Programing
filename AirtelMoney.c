                     ...
                     case 1:
                        while (4) {
                           ...
                           case 1:
                              ...
                              printf("\t\tEnter Ammount: ");
                              scanf("%d", & Ammount);
                              printf("\t\tYou have successfuly sent %d Rwanda francs to %d\n\n", Ammount, MobileNumber);
                              break;
                     ...
                     case 2:
                        while (5) {
                           ...
                           case 1:
                              ...
                              printf("\t\tEnter Ammount: ");
                              scanf("%d", & Ammount);
                              printf("\t\tYou have successfuly sent %d Zambia shs to %d\n\n", Ammount, MobileNumber);
                              break;
                           ...
                           case 3:
                              while (6) {
                                 ...
                                 case 1:
                                    ...
                                    printf("\t\tEnter Ammount: ");
                                    scanf("%d", & Ammount);
                                    printf("\t\tYou have successfuly sent %d Tanzania shs to %d\n\n", Ammount, MobileNumber);
                                    break;
                                 ...
                                 case 4:
                                    while (7) {
                                       ...
                                       case 1:
                                          ...
                                          printf("\t\tEnter Ammount: ");
                                          scanf("%d", & Ammount);
                                          printf("\t\tYou have successfuly sent %d Malawi shs to %d\n\n", Ammount, MobileNumber);
                                          break;
                                       ...
                                       case 5:
                                          while (8) {
                                             ...
                                             case 1:
                                                ...
                                                printf("\t\tEnter Ammount: ");
                                                scanf("%d", & Ammount);
                                                printf("\t\tYou have successfuly sent %d Burundi francs to %d\n\n", Ammount, MobileNumber);
                                                break;
                                             ...
                                             case 6:
                                                while (9) {
                                                   ...
                                                   case 1:
                                                      ...
                                                      printf("\t\tEnter Ammount: ");
                                                      scanf("%d", & Ammount);
                                                      printf("\t\tYou have successfuly sent %d Zimbabwe Dollars to %d\n\n", Ammount, MobileNumber);
                                                      break;
